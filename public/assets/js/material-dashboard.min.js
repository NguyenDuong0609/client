...
isWindows ? (0 != $(".main-panel").length && (mainpanel = document.querySelector(".main-panel"),
ps = new PerfectScrollbar(mainpanel)),
0 != $(".sidebar").length && (sidebar = document.querySelector(".sidebar"),
ps1 = new PerfectScrollbar(sidebar)),
0 != $(".sidebar-wrapper").length && (sidebarwrapper = document.querySelector(".sidebar-wrapper"),
ps2 = new PerfectScrollbar(sidebarwrapper)),
0 != $(".dropdown-menu").length && (dropdownmenu = document.querySelector(".dropdown-menu"),
ps3 = new PerfectScrollbar(dropdownmenu)),
0 != $(".page-header").length && (pageheader = document.querySelector(".page-header"),
...
$(document).on("click", ".navbar-toggler", function() {
    var e;
    $toggle = $(this),
    mobile_menu_visible = 1 == mobile_menu_visible ? ($("html").removeClass("nav-open"),
    $(".close-layer").remove(),
    setTimeout(function() {
...
md = {
    ...
    checkSidebarImage: function() {
        ...
        void 0 !== image_src && $(".sidebar-background").css("background-image", "url(" + image_src + ")")
    },
    ...
    //     })
    // },
    showNotification: function(e, t, type, message) {
        color = Math.floor(6 * Math.random() + 1),
        $.notify({
            icon: "add_alert",
            message: message
    ...
    initDashboardPageCharts: function() {
        ...
        e = new Chartist.Line("#dailySalesChart",dataDailySalesChart,optionsDailySalesChart),
        ...
        t = new Chartist.Line("#completedTasksChart",dataCompletedTasksChart,optionsCompletedTasksChart),
        md.startAnimationForLineChart(t),
        a = Chartist.Bar("#websiteViewsChart", {
        ...
        $calendar.fullCalendar({
            ...
            select: function(a, i) {
                swal({
                    ...
                    $calendar.fullCalendar("renderEvent", t, !0)),
...
demo = {
        ...
        $(function() {
            ...
            function e() {
                ...
                $(".add-animation.animated").each(function(e) {
                    ...
                    win_height_padded = .8 * windowHeight,
                    scrolled + win_height_padded < t && $(this).removeClass("animated")
                })
            }
    ...
    initPickColor: function() {
        $(".pick-class-label").click(function() {
            ...
            i.length && ((e = i.find(".btn")).removeClass(a),
            e.addClass(t),
            i.attr("data-class", t))
        })
    },
    initMaterialWizard: function() {
        ...
        function r(e, t) {
            ...
            mobile_device && (move_distance = e.width() / 2,
            index_temp = t % 2,
            $li_width = 50),
            ...
            $current = t + 1,
            1 == $current || 1 == mobile_device && t % 2 == 0 ? move_distance -= 8 : ($current == total_steps || 1 == mobile_device && t % 2 == 1) && (move_distance += 8),
            mobile_device && (vertical_level = parseInt(t / 2),
            vertical_level *= 38),
        ...
        $(".card-wizard").bootstrapWizard({
            ...
            onTabShow: function(e, t, a) {
                ...
                i <= n ? ($(o).find(".btn-next").hide(),
                $(o).find(".btn-finish").show()) : ($(o).find(".btn-next").show(),
                $(o).find(".btn-finish").hide()),
                button_text = t.find("li:nth-child(" + n + ") a").html(),
                setTimeout(function() {
    ...
    initCharts: function() {
        ...
        e = new Chartist.Line("#roundedLineChart",dataRoundedLineChart,optionsRoundedLineChart),
        md.startAnimationForLineChart(e),
        ...
        t = new Chartist.Line("#straightLinesChart",dataStraightLinesChart,optionsStraightLinesChart),
        md.startAnimationForLineChart(t),
        ...
        a = new Chartist.Line("#colouredRoundedLineChart",dataColouredRoundedLineChart,optionsColouredRoundedLineChart),
        ...
        i = new Chartist.Line("#colouredBarsChart",dataColouredBarsChart,optionsColouredBarsChart),
        ...
        o = Chartist.Bar("#multipleBarsChart", {
            labels: ["Jan", "Feb", "Mar", "Apr", "Mai", "Jun", "Jul", "Aug", "Sep", "Oct", "Nov", "Dec"],
