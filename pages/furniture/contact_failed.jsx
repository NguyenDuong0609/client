                                ...
                                <div className="banner">
                                    <div className="row">
                                        <div className="col-md-offset-1 col-md-10 text-center">
                                            <h2 className="title">Message not sent!</h2>
                                            <p>
                                            ...
                                            <div className="contact-form-wrapper">
                                                ...
                                                <a className="btn btn-clean open-form" data-text-open="Contact us via form" data-text-close="Close form">Try again</a>
                                                        ...
                                                        <div className="row">
                                                            <div className="col-md-6">
                                                                <div className="form-group">
                                                                    <input id="Name" name="Name" type="text" className="form-control" placeholder="Your name" required="required"/>
                                                                </div>
                                                            </div>

                                                            <div className="col-md-6">
                                                                <div className="form-group">
                                                                    <input id="Email" name="Email" type="email" className="form-control" placeholder="Your email" required="required"/>
                                                                </div>
                                                            </div>

                                                            <div className="col-md-12">
                                                                <div className="form-group">
                                                                    <input id="Subject" name="Subject" type="text" className="form-control" placeholder="Subject" required="required"/>
                                                                </div>
                                                            </div>
